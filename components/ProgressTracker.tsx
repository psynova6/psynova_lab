...
const SessionHistory: React.FC<SessionHistoryProps> = React.memo(({ sessionHistory }) => (
  <div className="bg-white/60 rounded-[2rem] shadow-lg p-4 md:p-6 w-full">
  ...
  return (
    <section className="py-16">
      <div className="text-center mb-12">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-dark-green">Your Session History</h2>
