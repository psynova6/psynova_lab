                ...
                <div className="p-6 md:p-8 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" id="date" value={date} min={getMinDate()} onChange={(e) => setDate(e.target.value)} aria-label="Due date for reminder" className="w-full px-3 py-2 border border-brand-light-green/50 rounded-2xl focus:ring-brand-dark-green focus:border-brand-dark-green bg-white/50" />
                        </div>
                        <div>
                            <label htmlFor="time" className="block text-sm font-medium text-brand-dark-green/80 mb-1">Time</label>
                            <input type="time" id="time" value={time} onChange={(e) => setTime(e.target.value)} aria-label="Due time for reminder" className="w-full px-3 py-2 border border-brand-light-green/50 rounded-2xl focus:ring-brand-dark-green focus:border-brand-dark-green bg-white/50" />
                        </div>
                    </div>
                    <div>
