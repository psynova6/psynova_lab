...
export const RobotIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <rect x="5" y="8" width="14" height="12" rx="3" strokeLinecap="round" strokeLinejoin="round" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 13h.01M15 13h.01M10 17h4" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2 12h3M19 12h3" />
    </svg>
);

export const TherapistIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const BreathingIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.25 10.25h-6.5a1.5 1.5 0 0 0 0 3h6.5a1.5 1.5 0 0 0 0-3zM3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75v1.5M12 18.75v1.5M20.25 12h-1.5M5.25 12h-1.5" />
    </svg>
);
...
export const AlarmClockIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 3l3 3" />
    </svg>
);
...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a11.955 11.955 0 019-2.606 11.955 11.955 0 019 2.606 12.02 12.02 0 00-2.382-9.988z" />
    </svg>
);
...
export const NotificationIconRenderer: React.FC<{ iconName: string }> = ({ iconName }) => {
    const IconComponent = iconMap[iconName] || NotificationIcon; // Default icon
    return <IconComponent className="w-5 h-5 text-brand-dark-green" />;
};